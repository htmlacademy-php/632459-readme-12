                    ...
                    <div class="post-details__rating user__rating">
                        <p class="post-details__rating-item user__rating-item user__rating-item--subscribers">
                            <span
                                ...
                                ?? '' ?></span>
                            <span
                                class="post-details__rating-text user__rating-text"><?= isset($subscribers['total']) ? get_noun_plural_form(
                                    $subscribers['total'],
                                    'подписчик',
                                    'подписчика',
                                    'подписчиков'
                        ...
                        <p class="post-details__rating-item user__rating-item user__rating-item--publications">
                            <span
                                ...
                                ?? '' ?></span>
                            <span
                                class="post-details__rating-text user__rating-text"><?= isset($publications['total']) ? get_noun_plural_form(
                                    $publications['total'],
                                    'публикация',
                                    'публикации',
                                    'публикаций'
