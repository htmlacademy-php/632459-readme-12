            ...
            <div class="profile__user user container">
                <div class="profile__user-info user__info">
                    ...
                    <div class="profile__name-wrapper user__name-wrapper">
                        <span
                            class="profile__name user__name"><?= $user['login']
                            ?? '' ?></span>
                ...
                <div class="profile__tabs filters">
                    ...
                    <ul class="profile__tabs-list filters__list tabs__list">
                        <li class="profile__tabs-item filters__item">
                            <a href="profile.php?user=<?= $_GET['user'] ?>&tab=posts"
                               class="profile__tabs-link filters__button <?= $_GET['tab']
                               === 'posts'
                                   ? 'filters__button--active tabs__item--active'
                                   : '' ?> tabs__item button">Посты</a>
                        </li>
                        <li class="profile__tabs-item filters__item">
                            <a class="profile__tabs-link filters__button <?= $_GET['tab']
                            === 'likes'
                                ? 'filters__button--active tabs__item--active'
                                : '' ?> tabs__item button"
                               href="profile.php?user=<?= $_GET['user'] ?>&tab=likes">Лайки</a>
                        </li>
                        <li class="profile__tabs-item filters__item">
                            <a class="profile__tabs-link filters__button <?= $_GET['tab']
                            === 'subs'
                                ? 'filters__button--active tabs__item--active'
                                : '' ?> tabs__item button"
                               href="profile.php?user=<?= $_GET['user'] ?>&tab=subs">Подписки</a>
                        </li>
                    </ul>
                </div>
                <div class="profile__tab-content">
                    <section
                        class="profile__posts tabs__content <?= $_GET['tab']
                        === 'posts' ? 'tabs__content--active' : '' ?>">
                        <h2 class="visually-hidden">Публикации</h2>
                        <?php
                        foreach ($posts as $index => $post): ?>
                            <article
                                class="profile__post post <?= $post['class'] ??
                                '' ?>">
                                    ...
                                    if ($post['repost']): ?>
                                        <div class="post__author">
                                            <a class="post__author-link"
                                               href="/profile.php?user=<?= $post['original_author']
                                               .'&tab=posts' ?? '' ?>"
                                               title="Автор">
                                                <div
                                                ...
                                                <div class="post__info">
                                                    <b class="post__author-name">Репост: <?= $post['login']
                                                        ?? '' ?></b>
                                ...
                                <div class="post__main">
                                    ...
                                    switch ($post['type']):
                                        ...
                                        case 'photo': ?>
                                            <div
                                                class="post-photo__image-wrapper">
                                ...
                                <div class="comments">
                                    <a class="comments__button button"
                                       href="/post.php?post=<?= $post['id'] ?>">Показать
                                        комментарии</a>
                                </div>
                            </article>
                        <?php
                    ...
                    <section
                        class="profile__likes tabs__content <?= $_GET['tab']
                        === 'likes' ? 'tabs__content--active' : '' ?>">
                        <h2 class="visually-hidden">Лайки</h2>
                        <ul class="profile__likes-list">
                            <?php
                            foreach ($profile_likes as $like): ?>
                                <li class="post-mini post-mini--<?= $like['type']
                                ?? '' ?> post user">
                                    <div
                                        class="post-mini__user-info user__info">
                                        <div
                                            class="post-mini__avatar user__avatar">
                                            <a class="user__avatar-link"
                                               href="/profile.php?user=<?= $like['id']
                                               .'&tab=posts' ?>">
                                                <img
                                                    class="post-mini__picture user__picture"
                                                    src="<?= $like['avatar_path']
                                                    ??
                                                    'img/userpic-tanya.jpg' ?>"
                                                    alt="Аватар пользователя">
                                            </a>
                                        ...
                                        <div
                                            class="post-mini__name-wrapper user__name-wrapper">
                                            <a class="post-mini__name user__name"
                                               href="/profile.php?user=<?= $like['id'] ?> . '&tab=posts'">
                                                <span><?= htmlspecialchars(
                                                        $like['login'] ?? ''
                                                    ) ?></span>
                                            </a>
                                    ...
                                    <div class="post-mini__preview">
                                        <a class="post-mini__link"
                                           href="/post.php?post=<?= $like['post_id'] ?>"
                                           title="Перейти на публикацию">
                                            ...
                                            switch ($post['type']):
                                                case 'photo': ?>
                                                    <div
                                                        class="post-mini__image-wrapper">
                                                        <img
                                                ...
                                                case 'quote': ?>
                                                    <svg
                                                        ...
                                                        width="21" height="20">
                                                        <use
                                                            xlink:href="#icon-filter-quote"></use>
                                                    </svg>
                                                    <?php
                                                    break ?>
                                                ...
                                                case 'text': ?>
                                                    <svg
                                                        ...
                                                        width="20" height="21">
                                                        <use
                                                            xlink:href="#icon-filter-text"></use>
                                                    </svg>
                                                    <?php
                                                    break ?>
                                                ...
                                                case 'link': ?>
                                                    <svg
                                                        ...
                                                        width="21" height="18">
                                                        <use
                                                            xlink:href="#icon-filter-link"></use>
                                                    </svg>
                                                    <?php
                                                    break ?>
                            ...
                            <svg class="post-mini__play-big-icon" width="12"
                              ...
                              <use xlink:href="#icon-video-play-big"></use>
                                            ...
                                            endswitch; ?>
                                            <span
                                                class="visually-hidden"><?= $like['name']
                                                ?? '' ?></span>
                                        </a>
                                    </div>
                                </li>
                    ...
                    <section
                        class="profile__subscriptions tabs__content <?= $_GET['tab']
                        === 'subs' ? 'tabs__content--active' : '' ?>">
                        <h2 class="visually-hidden">Подписки</h2>
                        <ul class="profile__subscriptions-list">
                            <?php
                            foreach ($profile_subs as $subscribe): ?>
                                <li class="post-mini post-mini--photo post user">
                                    <div
                                        ...
                                        <div
                                            class="post-mini__avatar user__avatar">
                                            <a class="user__avatar-link"
                                               href="/profile.php?user=<?= $subscribe['subscribe_id']
                                               .'&tab=posts' ?? '' ?>">
                                                <img
                                                    class="post-mini__picture user__picture"
                                                    src="<?= htmlspecialchars(
                                                        $subscribe['avatar_path']
                                                        ??
                                                        'img/userpic-tanya.jpg'
                                                    ) ?>"
                                                    alt="Аватар пользователя">
                                    ...
                                    <div class="post-mini__rating user__rating">
                                        <p class="post-mini__rating-item user__rating-item user__rating-item--publications">
                                            <span
                                                class="post-mini__rating-amount user__rating-amount"><?= $subscribe['posts_count']
                                                ?? '' ?></span>
                                            <span
                                                class="post-mini__rating-text user__rating-text"><?= get_noun_plural_form(
                                                    $subscribe['posts_count'],
                                                    ' публикация',
                                                    ' публикации',
                                                    ' публикаций'
                                                ) ?></span>
                                        ...
                                        <p class="post-mini__rating-item user__rating-item user__rating-item--subscribers">
                                            <span
                                                class="post-mini__rating-amount user__rating-amount"><?= $subscribe['subscription_count']
                                                ?? '' ?></span>
                                            <span
                                                class="post-mini__rating-text user__rating-text"><?= get_noun_plural_form(
                                                    $subscribe['subscription_count'],
                                                    ' подписчик',
                                                    ' подписчика',
                                                    ' подписчиков'
                                                ) ?></span>
                                    ...
                                    <div
                                        class="post-mini__user-buttons user__buttons">
                                        <form
                                            action="/subscribe.php?user=<?= $subscribe['id']
                                            ?? '' ?>" method="get">
                                            <input class="visually-hidden"
                                                   type="text" name="user"
                                                   value="<?= $subscribe['subscribe_id']
                                                   ?? '' ?>">
                                            <button
                                                class="post-mini__user-button user__button user__button--subscription button button--main"
                                                type="submit"><?= $subscribe['is_sub']
                                                    ? 'Отписаться'
                                                    : 'Подписаться' ?></button>
                                        </form>
                                    </div>
