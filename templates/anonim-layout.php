        ...
        <section class="authorization">
            ...
            <form class="authorization__form form" action="#" method="post">
                <div class="authorization__input-wrapper form__input-wrapper">
                    <div
                        class="form__input-section <?= $errors['authorize-login']
                        ?? null ? 'form__input-section--error' : '' ?>">
                        <input
                            class="authorization__input authorization__input--login form__input"
                            type="text" name="authorize-login"
                            value="<?= getPostVal('authorize-login') ?? '' ?>"
                            placeholder="Логин">
                ...
                <div class="authorization__input-wrapper form__input-wrapper">
                    <div
                        class="form__input-section <?= $errors['authorize-password']
                        ?? null ? 'form__input-section--error' : '' ?>">
                        <input
                            class="authorization__input authorization__input--password form__input"
                            type="password" name="authorize-password"
                            value="<?= getPostVal('authorize-password') ??
                            '' ?>" placeholder="Пароль">
            ...
            <div class="footer__my-info">
                <ul class="footer__my-pages">
                    <li class="footer__my-page footer__my-page--feed">
                        <a class="footer__page-link" href="<?= isset($_SESSION['user']['id']) ? '/feed.php?user='
