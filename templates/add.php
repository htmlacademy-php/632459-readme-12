            ...
            <nav class="header__nav">
                <ul class="header__my-nav">
                    <li class="header__my-page header__my-page--popular">
                        <a class="header__page-link" href="/popular.php?page=1"
                    ...
                    <li class="header__my-page header__my-page--feed">
                        <a class="header__page-link"
                           href="/feed.php?user=<?= $_SESSION['user']['id'] ?>"
                           title="Моя лента">
                ...
                <ul class="header__user-nav">
                    <li class="header__profile">
                        <a class="header__profile-link"
                           href="/profile.php?user=<?= $_SESSION['user']['id']
                           .'&tab=posts' ?? '' ?>">
        ...
        <div class="adding-post container">
            <div class="adding-post__tabs-wrapper tabs">
                    ...
                    <ul class="adding-post__tabs-list filters__list tabs__list">
                        ...
                        foreach ($types as $type): ?>
                            <li class="adding-post__tabs-item filters__item">
                                <a class="adding-post__tabs-link filters__button filters__button--<?= $type['type'] ?> <?= isset($_GET['type'])
                                && $_GET['type'] === $type['type']
                                    ? 'filters__button--active tabs__item--active'
                                    : '' ?> tabs__item button"
                                   href="/add.php?type=<?= $type['type'] ?>">
                ...
                <div class="adding-post__tab-content">
                    <section
                        class="adding-post__photo tabs__content <?= isset($_GET['type'])
                        && $_GET['type'] === 'photo' ? 'tabs__content--active'
                            : '' ?>">
                        <h2 class="visually-hidden">Форма добавления фото</h2>
                        <form class="adding-post__form form"
                              action="add.php?type=<?= $_GET['type'] ?>"
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="form__error-text">
                                                <h3 class="form__error-title"><?= $input_names['img_url']
                                                    ?? '' ?></h3>
                                                <p class="form__error-desc"><?= $errors['img_url']
                                                    ?? '' ?></p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <input
                                            ...
                                            id="userpic-file-photo" type="file"
                                            name="image">
                                        ...
                                        <div class="form__error-text">
                                            <h3 class="form__error-title">
                                                Файл</h3>
                                            <p class="form__error-desc"><?= $errors['image']
                                                ?? '' ?></p>
                                        </div>
                                    </div>
                                    <button
                    ...
                    <section
                        class="adding-post__video tabs__content <?= isset($_GET['type'])
                        && $_GET['type'] === 'video' ? 'tabs__content--active'
                            : '' ?>">
                                ...
                                <div class="form__text-inputs">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="form__error-text">
                                                <h3 class="form__error-title"><?= $input_names['video']
                                                    ?? '' ?></h3>
                                                <p class="form__error-desc"><?= $errors['video']
                                                    ?? '' ?></p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <section
                        class="adding-post__text tabs__content <?= isset($_GET['type'])
                        && $_GET['type'] === 'text' ? 'tabs__content--active'
                            : '' ?>">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <textarea
                                                ...
                                                id="post-text" name="text"
                                                value="<?= getPostVal('text') ??
                                                '' ?>"
                                            ...
                                            <div class="form__error-text">
                                                <h3 class="form__error-title"><?= $input_names['text']
                                                    ?? '' ?></h3>
                                                <p class="form__error-desc"><?= $errors['text']
                                                    ?? '' ?></p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <section
                        class="adding-post__quote tabs__content  <?= isset($_GET['type'])
                        && $_GET['type'] === 'quote' ? 'tabs__content--active'
                            : '' ?>">
                                ...
                                <div class="form__text-inputs">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="form__error-text">
                                                <h3 class="form__error-title"><?= $input_names['cite-text']
                                                    ?? '' ?></h3>
                                                <p class="form__error-desc"><?= $errors['cite-text']
                                                    ?? '' ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="form__error-text">
                                                <h3 class="form__error-title"><?= $input_names['quote-author']
                                                    ?? '' ?></h3>
                                                <p class="form__error-desc"><?= $errors['quote-author']
                                                    ?? '' ?></p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <section
                        class="adding-post__link tabs__content <?= isset($_GET['type'])
                        && $_GET['type'] === 'link' ? 'tabs__content--active'
                            : '' ?>">
                                ...
                                <div class="form__text-inputs">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="form__error-text">
                                                <h3 class="form__error-title"><?= $input_names['link']
                                                    ?? '' ?></h3>
                                                <p class="form__error-desc"><?= $errors['link']
                                                    ?? '' ?></p>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal__wrapper">
        ...
        <div class="modal__content">
            ...
            <p class="modal__desc">
                ...
                мире. Он окружен сефтью пешеходных маршрутов, называемых Большой
            ...
            <div class="modal__buttons">
                <a class="modal__button button button--main" href="#">Синяя
                    кнопка</a>
                <a class="modal__button button button--gray" href="#">Серая
                    кнопка</a>
            </div>
        </div>
    </div>
