<main class="page__main page__main--registration">
    ...
    <section class="registration container">
        ...
        <form class="registration__form form" action="reg.php" novalidate
              method="post" enctype="multipart/form-data">
            <div class="form__text-inputs-wrapper">
                <div class="form__text-inputs">
                    <div
                        class="registration__input-wrapper form__input-wrapper">
                        <label class="registration__label form__label"
                               for="registration-email">Электронная почта <span
                                class="form__input-required">*</span></label>
                        <div class="form__input-section <?= $errors['email-reg']
                        ?? null ? "form__input-section--error" : "" ?>">
                            <input class="registration__input form__input"
                                   id="registration-email" type="email"
                                   name="email-reg"
                                   value="<?= getPostVal('email-reg') ?? '' ?>"
                            ...
                            <div class="form__error-text">
                                <h3 class="form__error-title"><?= $input_names['email-reg']
                                    ?? '' ?></h3>
                                <p class="form__error-desc"><?= $errors['email-reg']
                                    ?? '' ?></p>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        null ? "form__input-section--error" : "" ?>">
                            <input class="registration__input form__input"
                                   id="registration-login" type="text"
                                   name="login"
                            ...
                            <div class="form__error-text">
                                <h3 class="form__error-title"><?= $input_names['login']
                                    ?? '' ?></h3>
                    ...
                    <div
                        ...
                        ?? null ? "form__input-section--error" : "" ?>">
                            ...
                            <div class="form__error-text">
                                <h3 class="form__error-title"><?= $input_names['password']
                                    ?? '' ?></h3>
                    ...
                    <div
                        class="registration__input-wrapper form__input-wrapper">
                        <label class="registration__label form__label"
                               for="registration-password-repeat">Повтор
                            пароля<span
                                class="form__input-required">*</span></label>
                        <div
                            class="form__input-section <?= $errors['password-repeat']
                            ?? null ? "form__input-section--error" : "" ?>">
                            <input class="registration__input form__input"
                            ...
                            <div class="form__error-text">
                                <h3 class="form__error-title"><?= $input_names['password-repeat']
                                    ?? '' ?></h3>
                                <p class="form__error-desc"><?= $errors['password-repeat']
                                    ?? '' ?></p>
                            </div>
                        </div>
                    </div>
