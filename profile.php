...
$sql_posts
    = 'SELECT posts.*, type, class, original_author, login, avatar_path, '
...
$sql_profile_likes
    = 'SELECT l.*, img, type, name, u.id, login, avatar_path FROM likes l '
...
$sql_profile_subscribes
    = 'SELECT s.subscribe_id, u.id, login, avatar_path, dt_reg, '
